...
- تصدير **PDF** عبر طباعة المتصفح (مع عزل الواجهة) + دعم Ctrl/⌘+P
...
- استخدم زر **تصدير PDF** داخل الصفحة.
- يدعم Ctrl/⌘+P بدون ظهور الواجهة بفضل قواعد `@media print`.

### إعدادات الطباعة الموصى بها (مهم)
**جودة الـPDF تعتمد على إعدادات نافذة الطباعة.** عند Save as PDF تأكد من:
- Paper size: **A4**
